...
const Contact = () => {
  ...
  const renderNoContactAvailable = () => {
    return (
      <div className="bg-[#F3F3F3] p-5 flex flex-col items-center md:h-screen md:w-full justify-center text-[#36454F]">
        <button
          type="button"
          className="font-bold md:text-2xl text-1xl bg-[#FF0000] text-white px-[20px] py-[15px] rounded-[15px] hover:bg-indigo-300 hover:text-black"
  ...
  const contactListItem = () => {
    return (
      <div className="bg-[#F3F3F3] flex  flex-col md:h-screen md:w-full items-center mt-12">
        ...
        <button
          type="button"
          className="fixed bottom-[20px] font-bold md:text-2xl text-1xl bg-[#FF0000] px-[20px] py-[15px] rounded-[15px] text-white hover:bg-indigo-300 hover:text-black"
          onClick={() => dispatchFn(changeCreateContactStatus())}
        >
          Create Contact
        </button>
