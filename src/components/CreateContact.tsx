...
const AddContact = () => {
  ...
  return (
    <div className="overflow-visible md:h-screen h-[580px] md:w-full flex flex-col md:text-center items-center justify-center border text-[#36454F] -[#F3F3F3]">
      <h1 className="text-[25px] md:text-3xl mb-8 font-bold text-[#FF0000]">
        Create New Contact
      </h1>
      <form onSubmit={submitContactForm}>
        ...
        <div className="flex flex-row flex-wrap align-center justify-center text-center">
          <button
            ...
            className="hover:bg-indigo-300 hover:text-[#36454F] md:h-[50px] h-[40px] md:w-[150px] w-[125px] text-white font-bold rounded-xl drop-shadow-md bg-[#FF0000] mt-5"
            type="submit"
          >
            Save Contact
          </button>
          <button
            ...
            className="hover:bg-indigo-300 hover:text-[#36454F] md:h-[50px] h-[40px] md:w-[150px] w-[125px] text-white font-bold rounded-xl drop-shadow-md bg-[#FF0000] mt-5 ml-3"
            type="submit"
          >
            Close
          </button>
